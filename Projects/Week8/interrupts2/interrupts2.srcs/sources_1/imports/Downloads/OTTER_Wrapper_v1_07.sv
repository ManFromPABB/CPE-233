...
module OTTER_Wrapper(
   ...
   logic debounce_out, oneshot_out;
   ...
   DBounce #(.n(1)) my_dbounce(
    .clk    (clk),
    .sig_in (buttons[4]),
    .DB_out (debounce_out)   );
    
    one_shot_bdir  #(.n(2)) my_oneshot (
    .clk           (clk),
    .sig_in        (debounce_out),
    .pos_pulse_out (oneshot_out), 
    .neg_pulse_out ()  );
   
   assign s_interrupt = oneshot_out;  // for btn(4) connecting to interrupt
